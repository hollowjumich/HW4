load("/cloud/project/preprint_growth.rda") #please change the path if needed
...
ggplot(preprints) +
  ...
  scale_color_manual(values = c("#00ffb1", "#e500ff", "#2f006f"), 
    name = NULL) +
  theme(legend.position = "none")


#To update the table as directed changed these lines of code: 
#               limits = c(ymd("2015-01-01"), ymd("2017-01-01"))) + 
#  scale_color_manual(values = c("#00ffb1", "#e500ff", "#2f006f"), 
#updated min value to specific date instaed of minimum value in the column. 
#updated hexes to color scheme from https://www.color-hex.com/color-palette/1046370
